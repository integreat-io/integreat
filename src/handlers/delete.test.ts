...
test('delete handler', async (t) => {
  ...
  await t.test('should delete items from service', async () => {
  ...
  await t.test('should delete one item from service', async () => {
  ...
  await t.test('should delete item from service given by id', async () => {
    const scope = nock('http://api1.test')
  ...
  await t.test('should delete items from service with params', async () => {
  ...
  await t.test('should return error from response', async () => {
