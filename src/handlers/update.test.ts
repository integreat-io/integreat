...
test('update handler', async (t) => {
  ...
  await t.test('should send UPDATE action to UPDATE endpoint', async () => {
  ...
  await t.test(
    'should send UPDATE action to UPDATE endpoint when endpoint matches several actions',
    async () => {
      const createdAt = new Date()
      const scope = nock('http://api1.test')
        .post('/database/update/ent1', {
  ...
  await t.test(
    'should send UPDATE action to UPDATE endpoint with several items',
    async () => {
      const createdAt = new Date()
  ...
  await t.test(
    'should send UPDATE action to UPDATE endpoint with id and no data',
    async () => {
  ...
  await t.test(
    'should send UPDATE action to GET and SET endpoints',
    async () => {
      const createdAt = new Date()
  ...
  await t.test(
    'should send UPDATE action to GET and SET endpoints with several items',
    async () => {
      const createdAt = new Date()
  ...
  await t.test('should not override createdAt in fetched data', async () => {
    const createdAt = new Date()
  ...
  await t.test(
    'should not override createdAt in array of fetched data',
    async () => {
      const createdAt = new Date()
  ...
  await t.test(
    'should set updatedAt to now when found in merged data',
    async () => {
  ...
  await t.test(
    'should respond with error when the original data and the gotten data is not both array or non-array',
    async () => {
  ...
  await t.test('should return error from GET', async () => {
  ...
  await t.test('should return error from SET', async () => {
