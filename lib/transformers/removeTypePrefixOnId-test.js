...
test('should remove type going from source', (t) => {
...
test('should not touch unprefixed id going from source', (t) => {
...
test('should add type going to source', (t) => {
  const item = {id: 'ent1', type: 'entry'}
...
test('should not touch prefixed id going to source', (t) => {
  const item = {id: 'entry:ent1', type: 'entry'}
