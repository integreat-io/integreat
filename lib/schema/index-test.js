...
test('cast should remove isTrue and isDeleted when false', (t) => {
  ...
  t.is(ret.isNew, undefined)
  t.is(ret.isDeleted, undefined)
})
...
test('cast should allow null for all field types', (t) => {
  ...
  t.is(ret.attributes.title, null)
  t.is(ret.attributes.views, null)
  t.is(ret.attributes.active, null)
  t.is(ret.attributes.rating, null)
...
test('cast should include default attributes', (t) => {
  ...
  t.is(ret.attributes.views, undefined)
