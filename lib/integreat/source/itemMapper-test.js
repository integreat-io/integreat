...
test('fromSource should map attributes', (t) => {
  ...
  const item = itemMapper({type: 'entry', attrs})
...
test('fromSource should not use source type as type for item', (t) => {
  ...
  const attrs = [{key: 'type', path: 'type'}]
  const item = itemMapper({type: 'entry', attrs})
...
test('fromSource should use createdAt when updatedAt is not set', (t) => {
  ...
  const attrs = [{key: 'createdAt', type: 'date', path: 'createdAt'}]
  const item = itemMapper({type: 'entry', attrs})
...
test('fromSource should set relationships', (t) => {
  ...
  const rels = [{key: 'comments', type: 'comment', path: 'item.note'}]
  const item = itemMapper({type: 'entry', rels})
...
test('fromSource should set relationship with array', (t) => {
  ...
  const rels = [{key: 'comments', type: 'comment', path: 'item.notes'}]
  const item = itemMapper({type: 'entry', rels})
...
test('fromSource should use map pipeline', (t) => {
  ...
  const item = itemMapper({type: 'entry', attrs, map})
...
test('toSource should transform attributes', (t) => {
  ...
  const attrs = [{key: 'one', type: 'integer', path: 'values.first', transform}]
  const item = itemMapper({type: 'entry', attrs})
...
test('toSource should not throw on missing attributes', (t) => {
  ...
  const attrs = [{key: 'one', type: 'integer', path: 'values.first'}]
  const item = itemMapper({type: 'entry', attrs})
...
test('toSource should map id', (t) => {
  ...
  const attrs = [{key: 'id', type: 'string', path: 'key'}]
  const item = itemMapper({type: 'entry', attrs})
...
test('toSource should map type', (t) => {
  const data = {id: 'item1', type: 'entry'}
  const attrs = [{key: 'type', type: 'string', path: 'type'}]
  const item = itemMapper({type: 'entry', attrs})
...
test('toSource should transform relationships', (t) => {
  ...
  const rels = [{key: 'comments', type: 'comment', path: 'item.note', transform}]
  const item = itemMapper({type: 'entry', rels})
