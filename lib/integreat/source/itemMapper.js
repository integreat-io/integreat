 ...
 * @param {Object} params - Name parameters: type, path, attrs, ret, map, and filters
 * @returns {Object} Item mapper object
 */
function itemMapper ({type = 'unset', path = null, attrs: attrParams, rels: relParams, map = null, filterFrom, filterTo} = {}) {
