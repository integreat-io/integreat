...
function source (
  ...
  return {
     ...
     */
    async mapFromSource (data, type, {path = null, params = {}, useDefaults = true} = {}) {
      if (type && data) {
     ...
     */
    async retrieve ({endpoint: endpointId, params = {}, type, useDefaults = true}) {
