...
test('should send data and return status with endpoint prop', async (t) => {
  ...
  const request = {endpoint, data, id: 'ent1', type: 'entry'}
...
test('should user params to generate uri', async (t) => {
  const data = {id: 'ent1', title: 'Entry 1'}
  ...
  const request = {endpoint, data, id: 'ent1', type: 'entry', params: {folder: 'entries'}}
