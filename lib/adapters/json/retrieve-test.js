...
test('should return json object', async (t) => {
  ...
  nock('http://test.site')
    .get('/items')
    .reply(200, data)
  const request = {uri: 'http://test.site/items'}

  const ret = await retrieve(request)
...
test('should return ok status on all 200-range statuses', async (t) => {
  ...
  nock('http://test.site')
    .get('/partial')
    .reply(206, data)
  const request = {uri: 'http://test.site/partial'}
...
test('should return error with status notfound', async (t) => {
  nock('http://test.site')
    .get('/unknown')
    .reply(404)
  const request = {uri: 'http://test.site/unknown'}
...
test('should return error on other error', async (t) => {
  nock('http://test.site')
    .get('/timeout')
    .reply(408)
  const request = {uri: 'http://test.site/timeout'}
...
test('should return error on request error', async (t) => {
  ...
  const request = {uri: 'http://test.site/error'}
...
test('should return error with autherror', async (t) => {
  ...
  const req = nock('http://test.site')
    .get('/authfailed')
    .reply(200, {data: []})
  const request = {uri: 'http://test.site/authfailed', auth}
...
test('should retrieve when authentication is successful', async (t) => {
  ...
  nock('http://test.site')
    .get('/authsuccess')
    .reply(200, {data: []})
  const request = {uri: 'http://test.site/authsuccess', auth}
...
test('should retrieve with auth headers', async (t) => {
  ...
  nock('http://test.site', {
    ...
    .get('/authorize')
    .reply(200, {data: []})
  const request = {uri: 'http://test.site/authorize', auth}
...
test('should authenticate when request returns 401', async (t) => {
  ...
  const req = nock('http://test.site')
    ...
    .get('/reauth')
    .reply(200, {data: []})
  const request = {uri: 'http://test.site/reauth', auth}
...
test('should authenticate only once when request returns 401', async (t) => {
  ...
  const req = nock('http://test.site')
    ...
    .get('/rereauth')
    .reply(401, {})
  const request = {uri: 'http://test.site/rereauth', auth}
