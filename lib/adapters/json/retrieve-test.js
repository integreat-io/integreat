...
test.todo('should return ok status on all 200-range statuses')

test('should return error object with status notfound', async (t) => {
  nock('http://test.site')
    .get('/unknown')
    .reply(404)
...
test('should return error object on other error', async (t) => {
  t.plan(2)
  nock('http://test.site')
    .get('/error')
