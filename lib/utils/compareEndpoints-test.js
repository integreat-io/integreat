...
const endpointServiceParam = {params: {service: true}}
const endpointServiceParamOptional = {params: {service: false}}
const endpointServiceAuthorParams = {params: {service: true, author: false}}
...
const endpointId = {id: 'endpoint1', params: {includeDocs: false}}
