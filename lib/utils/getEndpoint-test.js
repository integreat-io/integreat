...
test('should return endpoint based on action array', (t) => {
  ...
  const request = {action: 'POST', type: 'entry'}
...
test('should return endpoint based on members scope', (t) => {
  ...
  const request = {action: 'GET', type: 'entry', params: {id: ['ent1', 'ent2']}}
...
test('should return endpoint with the given id', (t) => {
  ...
  const request = {action: 'GET', type: 'entry', params: {id: 'ent1'}, endpoint: 'endpoint1'}
...
test('should match when required params is present', (t) => {
  ...
  const request = {action: 'GET', type: 'entry', params: {author: 'johnf'}}
