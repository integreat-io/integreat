...
const mockdapter = {
  retrieve: () => Promise.resolve([
    {id: 'item1', title: 'First item', createdAt: mockdate, changedAt: mockdate},
    {id: 'item2', title: 'Second item', createdAt: mockdate, changedAt: mockdate}
  ]),
...
test('should retrieve, map, and return items', (t) => {
  ...
  const expected = [
    {id: 'item1', type: 'entry', attributes: {name: 'First item'}, createdAt: mockdate, changedAt: mockdate},
    {id: 'item2', type: 'entry', attributes: {name: 'Second item'}, createdAt: mockdate, changedAt: mockdate}
  ]
