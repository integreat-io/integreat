...
import ItemMapper from '../integreat/source/itemMapper'
import ValueMapper from '../integreat/source/valueMapper'
...
test.skip('should retrieve, map, and return items', async (t) => {
...
test.skip('should retrieve, map, and return items with relationship', async (t) => {
  const adapter = {
    retrieve: () => Promise.resolve([
...
test.skip('should reject when no source definition', async (t) => {
  t.plan(2)
...
test.skip('should fetch through adapter with endpoint and auth', async (t) => {
  const spydapter = {
...
test.skip('should store items', async (t) => {
  const source = createSource(mockdapter)
...
test.skip('should map item with map pipeline', async (t) => {
  const source = createSource(mockdapter)
...
test.skip('should filter items', async (t) => {
  const source = createSource(mockdapter)
...
test.skip('should filter item through the filter pipeline', async (t) => {
  const source = createSource(mockdapter)
