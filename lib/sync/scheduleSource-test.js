...
test.skip('should schedule source', (t) => {
...
test.skip('should schedule source after last sync', (t) => {
  const {scheduler, schedule} = setupScheduler()
...
test.skip('should do nothing when no source definition', (t) => {
  const {scheduler, schedule} = setupScheduler()
...
test.skip('should do nothing when no sync definition', (t) => {
  const {scheduler, schedule} = setupScheduler()
  const source = new Source('entry')
...
test.skip('should do nothing when no schedule is defined', (t) => {
  const {scheduler, schedule} = setupScheduler()
  const source = new Source('entry')
...
test.skip('should do nothing when no scheduler', (t) => {
  t.notThrows(() => {
    scheduleSource(null, {})
  })
})
