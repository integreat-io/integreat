 ...
 * @param {Object} resources - Object with adapters, authenticators, filters, transformers, actions, and middlewares
...
function integreat (
  ...
  const services = R.compose(
    ...
    R.map(createService({
      ...
      auths,
      transformers,
      setupMapping: setupMapping({ filters, transformers, schemas })
    }))
  )(serviceDefs)
