 ...
 * @param {Object} resources - Object with adapters, authstrats, mutators, filters, formatters, actions, and middlewares
...
function integreat (
  ...
  const services = R.compose(
    ...
    R.map(createService({
      ...
      adapters,
      auths,
      setupMapping: setupMapping({ mutators, filters, formatters, schemas })
    }))
  )(serviceDefs)
