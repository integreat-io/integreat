  ...
  const expected = [
    {
      id: 'ent1',
      type: 'entry',
      attributes: {title: 'The heading', createdAt: new Date(), updatedAt: new Date()},
      relationships: {}
    },
    {
      id: 'acc1',
      type: 'account',
      attributes: {name: 'John', createdAt: new Date(), updatedAt: new Date()},
      relationships: {}
    }
  ]
...
test('prepareRequest should set typePlural from plurals dictionary', (t) => {
  ...
  const src = setupSource({id: 'accounts', endpoints, adapter: json}, {plurals})
