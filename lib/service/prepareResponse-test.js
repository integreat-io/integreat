...
test('should return status, data, and paging', (t) => {
  ...
  const ret = prepareResponse(response, {}, {schemas})
...
test('should authorize data', (t) => {
  ...
  const ret = prepareResponse(response, request, {schemas})
...
test('should not authorize data when unmapped is true', (t) => {
  ...
  const ret = prepareResponse(response, request, {schemas, unmapped: true})
