...
const sendOptions = { authenticator, adapter }
...
test('should authenticate and set authentication object', async (t) => {
  ...
  const ret = await authenticate({ ...sendOptions, authOptions })({ request })
...
test('should not reauthenticate when authentication object is already set', async (t) => {
  ...
  const ret = await authenticate({ ...sendOptions, authOptions })({ authentication, request })
...
test('should set auth object to null for unknown authentication method', async (t) => {
  ...
  const ret = await authenticate({ ...sendOptions, adapter, authOptions })({ request })
...
test('should not authenticate when no authenticator', async (t) => {
  ...
  const ret = await authenticate({ adapter, authOptions })({ request })
...
test('should retry authentication on timeout', async (t) => {
  ...
  const ret = await authenticate({
    ...sendOptions, authenticator: timeoutAuthenticator, authOptions
  })({ request })
...
test('should respond with autherror on error', async (t) => {
  ...
  const ret = await authenticate({
    ...sendOptions, authenticator: errorAuthenticator, authOptions
  })({ request })
...
test('should respond with autherror on unknown auth status', async (t) => {
  ...
  const ret = await authenticate({
    ...sendOptions, authenticator: unknownAuthenticator, authOptions
  })({ request })
