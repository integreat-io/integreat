...
test('should return object with version, dispatch, datatypes, and identType', (t) => {
  ...
  const great = integreat({services, datatypes, ident}, {adapters})
...
test('should dispatch', async (t) => {
  ...
  const great = integreat({services, datatypes, mappings}, {actions, adapters})
...
test('should call middleware dispatch', async (t) => {
  ...
  const great = integreat({services, datatypes, mappings}, {actions, adapters, middlewares})
  await great.dispatch(action)
...
test('should map data from service specified by type', async (t) => {
  ...
  const great = integreat({services, datatypes, mappings}, {adapters})
...
test('should map with item transformers', async (t) => {
  ...
  const great = integreat({services, datatypes, mappings}, {adapters, transformers})
  const ret = await great.dispatch(action)
...
test('should filter items', async (t) => {
  ...
  const great = integreat({services, datatypes, mappings}, {adapters, filters})
  const ret = await great.dispatch(action)
...
test('should use auth', async (t) => {
  ...
  const great = integreat({services, datatypes, mappings, auths}, {adapters, authstrats})
  const ret = await great.dispatch(action)
...
test('should ignore unknown auth', async (t) => {
  ...
  t.notThrows(() => {
    integreat({services, datatypes, auths}, {adapters, authstrats})
  })
})
...
test('should map with datatypes', async (t) => {
  ...
  const great = integreat({services, datatypes, mappings}, {adapters, formatters})
  const ret = await great.dispatch(action)
