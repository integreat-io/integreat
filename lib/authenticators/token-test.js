...
test('authenticate should return granted when token is set', async (t) => {
  ...
  const expected = { status: 'granted', token: 'someToken', encode: false, type: 'Bearer' }
...
test('asHttpHeaders should return auth header with token', (t) => {
  const authentication = { status: 'granted', token: 'someToken', type: 'Bearer' }
...
test('asHttpHeaders should return auth header with given type', (t) => {
  const authentication = { status: 'granted', token: 'someToken', type: 'Basic' }
...
test('asHttpHeaders should base64 encode token when options say so', (t) => {
  const authentication = { status: 'granted', token: 'someToken', type: 'Bearer', encode: true }
...
test('asHttpHeaders should return empty object when not granted', (t) => {
  const authentication = { status: 'refused', token: 'someToken', type: 'Bearer' }
  const expected = {}
...
test('asObject should encode token', (t) => {
  const authentication = { status: 'granted', token: 'someToken', encode: true, type: 'Bearer' }
...
test('asObject should return empty object when not granted', (t) => {
  const authentication = { status: 'refused', token: 'someToken', type: 'Basic' }
  const expected = {}
